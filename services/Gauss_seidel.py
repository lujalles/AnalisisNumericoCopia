...
def generate_pdf_report(output_filename, method_name, fn_str, params, results, tables, graphs):
    """
    Genera un PDF profesional con formato consistente
    Args:
        output_filename: Nombre del archivo de salida
        method_name: Nombre del método numérico
        fn_str: Representación del sistema de ecuaciones
        params: Diccionario de parámetros
        results: Diccionario de resultados
        tables: Lista de DataFrames con iteraciones
        graphs: Lista de tuplas (figura, título) para gráficos
    """
    with PdfPages(output_filename) as pdf:
        ...
        # ----------------------------
        # TABLAS DE ITERACIONES MEJORADAS
        # ----------------------------
        for i, table in enumerate(tables):
            ...
            for col in formatted_table.columns:
                if col != "Iteración":  # Todas las columnas excepto Iteración
            ...
            col_widths = [0.08] + [0.92/(num_cols-1)]*(num_cols-1)  # Ajuste dinámico
            ...
            tbl.set_fontsize(8)  # Tamaño reducido para mejor ajuste
            tbl.scale(1, 1.2)   # Escala más compacta
            ...
            for k, cell in tbl._cells.items():
                ...
                cell.set_height(0.05)  # Altura uniforme
                cell.PAD = 0.05       # Padding reducido
...
def calcular_gauss_seidel_y_generar_pdf(A, b, x0=None, tol=1e-6, max_iter=100):
    """
    ...
    try:
        ...
        tables = []
        rows_per_page = 12  # Menos filas por página para mejor legibilidad
        ...
        output_path = os.path.join('static', 'reporte_gauss_seidel.pdf')
...
if __name__ == "__main__":
    ...
    pdf_path = calcular_gauss_seidel_y_generar_pdf(A, b)
